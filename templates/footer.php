        ...
        <footer>
            <div class="center">
                ...
                <p>© <?php echo date('Y') ?> <a href="https://fapprik.com/" id="fapprik-copyright">fapprik</a> · <a href="/contributors">Contributors</a> · <span class="obfuscated" data-content="Ask us your JavaScript questions!">ask AT js-tricks DOT com</span>
            </div>
        </footer>
